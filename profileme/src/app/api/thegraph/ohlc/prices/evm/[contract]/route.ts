...
export async function GET(req: Request, context: { params: Promise<{ contract: string }> }) {
  ...
  try {
    ...
    const upstream = new URL(`https://token-api.thegraph.com/ohlc/prices/evm/${contract}`);
    // Forward query params like network_id, interval, startTime, endTime, limit, page
